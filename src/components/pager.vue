    ...
    <div class="clearfix">
        ...
        <nav class="fr">
            <ul class="pagination">
                ...
                <li v-for="p in grouplist" :class="{'active': current == p.val}" v-bind:key="p.val">
    ...
    export default {
        ...
        methods: {
            setCurrent: function (idx) {
                if (this.pageCurrent !== idx && idx > 0 && idx < this.page + 1) {
                    this.pageCurrent = idx;
                    this.$emit('page_change', this.pageCurrent);
                }
            },
            setSearch: function (idx) {
                this.pageCurrent = idx;
                this.$emit('page_change', this.pageCurrent);
            }
        }
